      ...
      <main class="main-container">
        ...
        <div class="main-cards">
          ...
          <div class="card">
            ...
            <span class="text-primary font-weight-bold">${numberOfProducts}</span>
          </div>
          ...
          <div class="card">
            ...
            <span class="text-primary font-weight-bold">${numberOfOrders}</span>
          </div>
          ...
          <div class="card">
            ...
            <span class="text-primary font-weight-bold">${numberOfUsers}</span>
          </div>
